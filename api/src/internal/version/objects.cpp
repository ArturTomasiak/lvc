...
static void get_all_objects(std::filesystem::path object, std::unordered_set<std::string>& out, std::string tree_id) {
    std::vector<std::string> content = file::content_lines(object / tree_id, 1);
...
std::unordered_set<std::string> version::objects(std::filesystem::path object, std::string version) {
    std::vector<std::string> version_content = file::content_lines(object / version, 1);
