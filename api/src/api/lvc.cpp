...
extern "C" LVC_API void lvc_create (LvcCreateInput input, char** error_message) noexcept {
    *error_message = 0;
    ...
    if (input.clone_repository)
        repository::clone(input.location, input.clone_repository, input.clone_versioning, error_message);
...
extern "C" LVC_API void lvc_unite(const char* lvc, const char* src_workspace_name, const char* dest_workspace_name, LvcConflictArray* conflicts, char** error_message) noexcept {
    // TODO
    *error_message = 0;
}

extern "C" LVC_API void lvc_insert(const char* lvc, const char* src_workspace_name, const char* dest_workspace_name, LvcConflictArray* conflicts, char** error_message) noexcept {
    // TODO
    *error_message = 0;
}
