...
static void tree_from_version(
    const std::filesystem::path& object_dir, std::vector<Tree>& trees, const std::string& tree_id, std::filesystem::path current, char** error_message) {
...
static std::string build(
    const std::filesystem::path& object_dir, const std::filesystem::path& working_dir, const std::string& tree_id, const std::vector<std::string>& status,
    char** error_message) {
