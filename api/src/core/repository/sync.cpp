...
LvcConflictArray repository::sync(const std::filesystem::path src_repository, const std::filesystem::path dest_repository) {
    ...
    std::vector<Object> src    = version::all_objects(src_object_directory, src_id, {});
    std::vector<Object> dest   = version::all_objects(dest_object_directory, dest_id, {});
    std::vector<Object> common = version::all_objects(src_object_directory, common_id, {});
